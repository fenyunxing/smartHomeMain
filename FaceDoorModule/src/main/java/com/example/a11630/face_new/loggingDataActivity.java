...
public class loggingDataActivity extends AppCompatActivity implements View.OnClickListener {
    //定义登录的姓名和ID号
    String names, IDs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loggingdata);
    ...
    public void onClick(View v) {
        ...
        if (names.equals("") || IDs.equals("")) {
            ...
            // 设置对话框标题
            new AlertDialog.Builder(loggingDataActivity.this)
                    .setTitle("系统提示")
                ...
                try {
                   ...
                   //  = "24.470560ecfc8ded10d622b3dd4e258f34.2592000.1563086633.282335-15236904";
                    ...
                    if (Error_code == 0) {
                        ...
                        SQLiteDatabase db;
                        MyHelper ggg = new MyHelper(loggingDataActivity.this);
                        ...
                        /**楼下这段话之后的语句跑不了**/
                        Looper.prepare();
                        Toast.makeText(loggingDataActivity.this, "上传成功", Toast.LENGTH_LONG).show();
                        Looper.loop();
                        ...
                        Looper.prepare();
                        Toast.makeText(loggingDataActivity.this, error_message, Toast.LENGTH_LONG).show();
                        Looper.loop();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
