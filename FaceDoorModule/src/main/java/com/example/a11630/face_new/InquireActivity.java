...
public class InquireActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.search_ka) {
            ...
            SQLiteDatabase db;
            MyHelper ggg = new MyHelper(InquireActivity.this);
            ...
            DatePickerDialog dialog = new DatePickerDialog(InquireActivity.this, new DatePickerDialog.OnDateSetListener() {
                @Override
